...
- Updated [`Button`] component. It uses native Base UI button component.
- Code style refactoring

## 11/11/2025

- Updated [`Combobox`](/docs/components/combobox) component. It uses native Base UI combobox component.
- Added [`Autocomplete`](/docs/components/autocomplete) component
- Updated Base UI to 1.0.0-beta.3
