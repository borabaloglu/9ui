...
Follow the [shadcn installation guide](https://ui.shadcn.com/docs/installation) to create a new project. If you already have a project with shadcn setup, you can skip this step.
...
<Step>Initialize 9ui</Step>

```bash title="Terminal"
npx shadcn@latest add @9ui/init
```

This will update your `globals.css` file with the necessary styling and install the required dependencies.

<Alert variant="warning" className="mt-4">
	<AlertTitle>
		Please note that shadcn includes default styles. It's recommended to review
		your globals.css file to check for any conflicts.
	</AlertTitle>
</Alert>
